...
$cfg{radius_auth}{0} = { server => "10.9.18.32:1812", timeout => 25, secret => "dsds" };
$cfg{radius_acct}{0} = { server => "10.9.18.32:1813", timeout => 25, secret => "dsdsdssword" };
$cfg{radius_auth}{1} = { server => "10.9.18.7:1812", timeout => 25, secret => "sddsdsword" };
$cfg{radius_acct}{1} = { server => "10.9.18.7:1813", timeout => 25, secret => "sddsdword" };

$cfg{nas_identifier} = "10.9.18.23"; ## By default equals to NAS IP-address
...
$cfg{srv}{TESTSERV}{rate_info} = "QD;0;0;U;0;0";
